...
int port_number = 8080;		 		// Common alternative port
...
int connectRemoteServer(char* host_addr, int port_num)
{
	...
	if(host == NULL)
	{
		fprintf(stderr, "Trying to create socket for remote server, No such host exists.\n");	
		return -1;
	}
	...
	//copy((char *)host->h_addr,(char *)&server_addr.sin_addr.s_addr,host->h_length);
